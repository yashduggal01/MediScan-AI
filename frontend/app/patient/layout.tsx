...
// 👇 Emergency form & modal components
import {
  Dialog,
  DialogContent,
  DialogHeader,
...
import EmergencyInfoForm from "@/components/patient/emergency-info" // 👈 make sure file path is correct
              ...
              <div className="flex items-center space-x-4">
                ...
                <Dialog>
                  ...
                  <DialogContent className="max-w-xl">
                    ...
                    {/* Replace with real userId from auth/session later */}
                    <EmergencyInfoForm userId="660d7ac294a4db315c112cf7" />
                  </DialogContent>
                </Dialog>
